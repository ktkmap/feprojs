...
(()=>{
    ...
    {
        console.log(helloGoodbyeNames[x]);
    }
    ...
    var combinedHelloGoodbye=[
        ...helloGoodbyeNames2.hello,
        ...helloGoodbyeNames2.goodbye
    ];

    for (var x=0;x<combinedHelloGoodbye.length;x++)
    {
        console.log(combinedHelloGoodbye[x]);
    }
})();
